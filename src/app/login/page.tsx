...
import { Loader2, Mail, LockKeyhole, ShieldAlert, Compass } from "lucide-react";
...
<g fill="#FFFFFF" opacity="0.95">
  ...
  <rect x="311" y="73" width="68" height="16" rx="8" />
    ...
    {/* Barraca */}
    <path d="M180 240 L250 120 L320 240 Z" fill="#059669" /> {/* Lateral escurecida */}
    <path d="M250 120 L320 240 L380 210 L310 90 Z" fill="#10B981" /> {/* Teto iluminado */}
    <path d="M250 120 L250 240 L285 240 L250 170 Z" fill="#047857" /> {/* Entrada sombreada */}

    {/* Chão */}
    <ellipse cx="200" cy="255" rx="180" ry="15" fill="#064E3B" opacity="0.2" />

    {/* Fogueira */}
{/* Lenha de fundo para dar profundidade */}
<rect x="192" y="244" width="36" height="6" rx="3" fill="#451A03" /> 

{/* Fogo camada externa (Laranja escuro) */}
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res?.error) {
      ...
      // Redireciona para o dashboard geral pós-login
      router.push("/admin");
      router.refresh();
    }
  };
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      // CORREÇÃO: Adicionado 'text-gray-900' abaixo
