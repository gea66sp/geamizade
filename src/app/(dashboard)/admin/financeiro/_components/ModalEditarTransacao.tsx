...
export default function ModalEditarTransacao({ transaction, isOpen, onClose, users }: ModalEditarTransacaoProps) {
      ...
      <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 w-full max-w-2xl shadow-2xl max-h-[95vh] overflow-y-auto custom-scrollbar relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              <label htmlFor="edit-tx-user" className="block text-sm font-bold text-gray-700">Vinculado a (Opcional)</label>
              <select 
                id="edit-tx-user"
                name="userId" 
              ...
              >
                <option value="">Nenhum (Transação Global)</option>
